...
Работа с базой данных и загрузка проекта в github. 

3. Что получилось особенно хорошо?
   
Гибкая фильтрация, чистая архитектура, авторизация через токен.

5. Что бы я доработал?
   
Роли (admin / user), docker-файл, и unit-тесты.

7. Сколько времени заняло выполнение?
   
3-4 дня.

9. Чему я научился?
    
В ходе выполнения проекта я приобрел понимание того, что такое FastAPI, запросы, и REST, приобрел навыки построения простых crud приложений.
